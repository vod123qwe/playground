...
- *Icon*: styl ikonki po lewej: **glyph** (symbol w szklanej kulce: trzy kropki, gdy nie wybrano agenta, potem lupa, stalówka albo kostka, które przelewają się jedno w drugie przy zmianie), **orb** (płynąca wielobarwna plazma w kulce, w kolorze agenta, przyspiesza przy przytrzymaniu), **emboss** (symbol wyrzeźbiony w powierzchni szkła, bez kulki). Przycisk **Fit the icon inside the glass** liczy największą kulkę, która w całości mieści się w bryle w miejscu ikonki (sprawdza 60 punktów na jej powierzchni względem tego samego pola odległości co shader) i ustawia ją na środku grubości szkła, z zapasem; sam ustawia *Size* i *Sink*. Do tego pokaż / ukryj kulkę, zadymienie, wielkość symbolu, ruch gradientu.
...
**Treść**: przycisk domyślnie „Ask an agent”, po wyborze „Research agent” itd. Pozycje menu to kropka i nazwa, z większymi odstępami; skróty 1, 2, 3 działają (gdy przycisk ma fokus albo menu jest otwarte), bez nadruku. *Liquid* na maksimum zlewa przycisk i menu w jedną miękką bryłę.
