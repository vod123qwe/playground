...
**Panel „Tune”** (przycisk w prawym górnym rogu; na telefonie wysuwa się od dołu). Grupy w kolejności pracy: Presets, Shape, Glass, Light, Shadow & glow, Icon, Menu, Label, Layout, Background, Sound. Styl panelu: ostry i minimalistyczny (bez zaokrągleń, płaskie obramowania, dzielniki przez całą szerokość między grupami). Każdą grupę można zwinąć (stan jest pamiętany), nagłówki przyklejają się przy przewijaniu, Reset i Copy są przyklejone na dole, a opcje zależne pokazują się tylko wtedy, gdy coś robią. Wszystkie 52 opcje przeszły automatyczny test (min i max zmieniają obraz albo układ).
...
- *Icon*: styl ikonki po lewej, każdy z własnymi ustawieniami (reszta się chowa). **glyph**: symbol w szklanej kulce (trzy kropki, gdy nie wybrano agenta, potem lupa, stalówka albo kostka, które przelewają się jedno w drugie); rozmiar, okrągłość, zatopienie, zadymienie, wielkość symbolu, ruch gradientu. **orb**: płynąca wielobarwna plazma w kulce, w kolorze agenta, przyspiesza przy przytrzymaniu; rozmiar, okrągłość, zatopienie, zadymienie, tempo, jasność. **emboss**: symbol wyrzeźbiony w powierzchni szkła, bez kulki; rozmiar, głębokość i matowienie rzeźbienia. Przycisk **Fit the icon inside the glass** (glyph i orb) najpierw spłaszcza kulkę w kształt M&M, zachowując jej szerokość, aż zmieści się w szkle; zmniejsza ją dopiero, gdy nie wystarczy nawet spłaszczenie (sprawdza 60 punktów na jej powierzchni względem tego samego pola odległości co shader) i ustawia ją na środku grubości szkła. Kulka jest elipsoidą, więc symbol w środku się nie deformuje.
