...
- *Shadow*: siła cienia i przełącznik **Glow**: po włączeniu zamiast cienia z kaustyką pod i wokół szkła rozlewa się kolorowa poświata, której barwy powoli płyną wzdłuż przycisku, jak podświetlenie za telewizorem. Dopiero wtedy pojawiają się palety (Aurora, Star, Ocean, Ember), siła, rozmiar i tempo ruchu; włączenie przy sile 0 samo ustawia domyślną. Przez szkło widać poświatę załamaną.
